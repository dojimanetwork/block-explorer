        ...
        <Paper className={classes.memosPaper}>
          <VerticalFlex>
            ...
            <Typography className={classes.memosTxt}>
              UnBOND:thor1yedw5cuz4l93wyj58wdn7s7z8qppfvusl3c66p
            </Typography>
            <Typography className={classes.outTxt}>
            OUT:27E341F3838FFA13DA35B89FDACA15B208C05A95088D1188B0F5B18A6E350713
            </Typography>
          </VerticalFlex>
        </Paper>
      </VerticalFlex>
...
export default TxDetailsUnBond;
