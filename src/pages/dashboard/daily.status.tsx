      ...
      <Paper className={classes.paperRoot}>
        <VerticalFlex>
          {dailyStatusData.map((data, index:number) =>(
            ...
            <Typography className={classes.title} style={{ opacity: data.titleOpacity }} >{data.title}</Typography>
            <Typography className={classes.value} style={{ opacity: data.valueOpacity, color: data.valueClr }}>{data.value}</Typography>
